            ...
            <ul class="todo-list">
                ...
                ?>
                    <div class='todo standard-todo'>
                        <li class='todo-item <?= $status == "done" ? "completed" : "" ?>'><?= $task_name ?></li>
                        <form method='post' action=''>
                            <button class='delete-btn standard-button' name='delete' value='<?= $index ?>'>
                                <i class='fas fa-trash'></i>
                            </button>
                        </form>
                        <form method='post' action=''>
                            <button class='check-btn standard-button' name='check' value='<?= $index ?>'>
